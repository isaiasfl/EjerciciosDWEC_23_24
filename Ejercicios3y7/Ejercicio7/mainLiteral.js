...
import { HotelLiteral, HabitacionLiteral, ReservaLiteral } from "./assets/module.js";

// Creación de una instancia de la clase HotelLiteral
const hotel = Object.create(HotelLiteral);

// Función para agregar una habitación al hotel
function agregarHabitacion(e) {
  e.preventDefault();

  // Creación de una instancia de la clase HabitacionLiteral
  const habitacion = Object.create(HabitacionLiteral);
  ...
  // Asignar número y precio de reserva a la habitación
  habitacion.numero = numHabitacion;
  habitacion.reserva = Object.create(ReservaLiteral);
  habitacion.reserva.precio = precioReserva;
...
function reservarHabitacionF(e) {
  ...
  habitacion.reserva = Object.create(ReservaLiteral);
  habitacion.reserva.precio = precioR;
...
function ocultarHabitaciones(e) {
  e.preventDefault();
  if (document.getElementById("habitacionesDisponibles").style.display == "block") {
    document.getElementById("habitacionesDisponibles").style.display = "none";
...
function ocultarReservasF(e) {
  e.preventDefault();
  if (document.getElementById("habitacionesReservadas").style.display == "block") {
