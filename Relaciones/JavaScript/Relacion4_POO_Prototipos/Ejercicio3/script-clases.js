...
y frenar. Este script contiene el ejercicio realizado con Clases.
 */

// ------------------- IMPORTS -------------------
import { MotoClass, CocheClass } from "./assets/modules";
...
const handleStartButton = (e) => {
  ...
  e.preventDefault();
  //Recogemos la info del formulario y creamos un objeto Coche utilizando clases.
  const marca = carBrandForm.value;
  const año = carYearForm.value;
  const modelo = carModelForm.value;
  coche = new CocheClass(marca, modelo, año);
...
const handleMotoStartButton = (e) => {
  ...
  //Recogemos la info del formulario y creamos un objeto Moto utilizando clases.
  const marca = motoBrandForm.value;
  const año = motoYearForm.value;
  const modelo = motoModelForm.value;
  moto = new MotoClass(marca, modelo, año);
